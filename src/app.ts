...
class App {
  ...
  private setRoutes(): void {
    ...
    this.app.get("/song/:songId", (req: Request, res: Response) => {
      const songId = req.params.songId;
      res.render("song", { songId });
    });
      ...
      (req: reqObject, res: Response) => {
        ...
        if (isValidRoute) {
          ...
          return res.status(403).render("error", {
            message: "Access denied. You can only view your own artist page.",
          });
        }
      }
    );
