...
import { searchSongValidationSchema, songValidationSchema } from "../modules/song/utils/song.validator.js";
...
router.post('/create', verifyJWT, uploadSong.fields([
...
// Search Songs API
router.get('/song/search',verifyJWT,validateRequest(searchSongValidationSchema), SongController.getSearchedSongs);
